...
plot(maize_mwi["maize_val_prod_all"], main="Maize value (US$)")
...
# library(tmap)
# tmap_mode("plot")
# I_maize_l_suitability_map=tm_shape(landunits_sp) +
# tm_polygons(col = "I_Maize_s_suit_num",palette = "-viridis", title = "Maize suitability class",     textNA = "Suitability not estimated",border.alpha = 0.1) +
#   tm_layout(legend.outside = TRUE,title.size=4)+
#   tmap_options(check.and.fix = TRUE)
# I_maize_l_suitability_map
